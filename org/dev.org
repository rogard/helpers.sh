...
#+name: doc-lead
#+begin_src org
  This meta-file is used for generating module files.
#+end_src
...
#+begin_src sh
  #===============================================================================
  # clone_test.sh — test for clone.sh
  #
  #  Author: Erwann Rogard
  #  License: GPL 3.0 (https://www.gnu.org/licenses/gpl-3.0.en.html)
  #
...
#+begin_src sh
  test-clone() {
      ...
      # Use absolute path to clone.sh relative to this test script
      script_path="${script_dir}/clone.sh"
